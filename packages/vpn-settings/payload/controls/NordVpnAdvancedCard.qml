    ...
    StyledRect {
        ...
        ColumnLayout {
            ...
            VpnSegmentedSwitch {
                ...
                Layout.fillWidth: true
                visible: root.has.technology === true
                // VpnSegmentedSwitch assigns currentIndex imperatively on click, so without a
                ...
                // VpnSegmentedSwitch assigns currentIndex imperatively on click, destroying the
